...
_GPUOPTIONS_EXPERIMENTAL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='disallow_retry_on_allocation_failure', full_name='tensorboard.GPUOptions.Experimental.disallow_retry_on_allocation_failure', index=10,
